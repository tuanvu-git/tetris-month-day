...
export default function Team({ data }) {
    return (
        <div
            className="p-0 title-hierarchy-line margin-bottom-15px team-cluster"
            team-id="5893"
        >
            <div
            ...
            >
                <div
                    className="updown-unlinked-icon d-lg-flex align-items-center updown-unlinked-icon-before"
                >
                ...
                <img alt=''
                    ...
                    data-toggle="tooltip"
                    data-html="true"
                    data-title="Delivery Manager"
                    src="./okr2_files/visualization-team-icon-c4abfa34bae8d3ceae07e6e35fcbb9a1c4b6ff9e788d4813475fe0a02588e4b6.svg"
                    data-original-title=""
                    title=""
                />
                <div
                    className="font-weight-bold font-size-18px color-gray-100 align-self-center w-100 d-flex justify-content-between align-items-center position-relative title-okrs"
                >
                        ...
                        <div className="process_title" id="team-5893">
                            <div className="process_title__1">
                                <span className="font-size-16px">
                                    ...
                                    <span
                                        className="progress-team color-green-100"
                                    >86%</span>
                                    | Score
