...
export default function DeptSectionV2() {
    const { state, setState } = useContext(OKRContext);
    console.log('state', state);
    return (
        <div id="wrapper">
            <div id="content-wrapper" className="d-flex flex-column position-relative">
                                        ...
                                        <div className="dept-section nested-sortable">
                                            {
                                                state.map(dept => (
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <div
                                                                className="updown-unlinked-icon d-lg-flex align-items-center d-none"
                                                            >
                                                                <img alt=''
                                                            ...
                                                            <div
                                                                className="font-weight-bold font-size-18px color-gray-100 align-self-center w-100 d-flex justify-content-between align-items-center"
                                                            >
                                                                ...
                                                                <div id="dept-2537">
                                                                    ...
                                                                    <span className="font-size-16px">
                                                                        - Progress
                                                                        <span className={`dept-progress ${dept.progressStatus ? 'color-red' : 'color-green-100'}`}>{dept.progress}%</span>
                                                                        | Score
                                                                        <span className={`dept-score ${dept.scoreStatus ? 'color-red' : 'color-green-100'}`}
                                                                        >{dept.score} ({dept.scoreStatus ? 'At Risk' : 'On Track'})</span>
                                                                    </span>
                                                                </div>
